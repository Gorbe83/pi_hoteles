...
class BuscarHotelRequest extends Request
{
    /**
    ...
    {
        return [
            'ciudad' =>'required|regex:/^[\pL\s\-]+$/u|max:50',
            'fechaLlegada' => 'required|date|after:tomorrow',
            'fechaIda' => 'required|date|after:fechaLlegada',
            'personas' => 'required|integer|max:7'
        ];
    }
    ...
    public function messages()
    {
        return [
            ...
            'ciudad.regex' => 'La ciudad solo debe contener letras',
            'ciudad.max' => 'La nombre de la ciudad no debe superar los 50 caracteres',
